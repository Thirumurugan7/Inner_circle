  ...
  return (
    <div className="flex flex-col gap-[8.55px] sm:gap-[15px] items-center pt-[11rem] min-h-screen">
      ...
      <div className="flex gap-[15px]">
        <Link to='/'>
          <button
            className="text-black cursor-pointer font-dmSans font-normal text-[9.12px] leading-[13.68px] lg:text-[16px] lg:leading-[24px] tracking-[0px] text-center bg-primary w-[85.47px] h-[25.07px] rounded-[6.84px] lg:w-[150px] lg:h-[44px] lg:rounded-[12px] sm:w-[87.88px] sm:h-[25.78px] sm:rounded-[7.03px] sm:text-[9.37px] sm;leading-[14.06px]"
          >
            Back to home
          </button>
        </Link>
        <a href="mailto:contact@innercircleecosystem.com">
          <button
            className="text-white cursor-pointer font-dmSans font-normal text-[9.12px] leading-[13.68px] lg:text-[16px] lg:leading-[24px] tracking-[0px] text-center bg-black w-[85.47px] h-[25.07px] rounded-[6.84px] lg:w-[150px] lg:h-[44px] lg:rounded-[12px] border-primary border-[0.59px] sm:w-[87.88px] sm:h-[25.78px] sm:rounded-[7.03px] sm:text-[9.37px] sm:leading-[14.06px]"
          >
            Contact us
          </button>
        </a>
